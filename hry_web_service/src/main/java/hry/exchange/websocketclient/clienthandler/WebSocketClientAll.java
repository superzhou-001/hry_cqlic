...
public class WebSocketClientAll {
	private String businessName;
	private String url = "ws://"
			+ PropertiesUtils.APP.getProperty("app.socketUrl")
			+ "/hurong_socketserver/hrywebsocket"+businessName;
	
//	private String url = "ws://localhost:6062/hurong_socketserver/hrywebsocket/"+businessName;
	
	private EventLoopGroup group;
	private Channel channel;

	public WebSocketClientAll(String s) {
		this.businessName = s;
	}

	public static WebSocketClientAll getClient(String s) {
		return new WebSocketClientAll(s);
	}
