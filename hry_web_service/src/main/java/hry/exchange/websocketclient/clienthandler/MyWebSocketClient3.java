...
public class MyWebSocketClient3 {
	 private String url = PropertiesUtils.APP.getProperty("app.socketUrl")
	 + "/index";
	//private String url = "wss://trades.btc123.com/kline";
	private EventLoopGroup group;
	private Channel channel;

	public MyWebSocketClient3() {

	}

	public static MyWebSocketClient3 getClient() {
		return new MyWebSocketClient3();
	}
