...
public class WebSocketClient4 {
	private String url = PropertiesUtils.APP.getProperty("app.socketUrl")
			+ "/market";
	// private String url = "ws://localhost:6062/hurong_socketserver/websocketclient";
	private EventLoopGroup group;
	private Channel channel;

	public WebSocketClient4() {

	}

	public static WebSocketClient4 getClient() {
		return new WebSocketClient4();
	}
