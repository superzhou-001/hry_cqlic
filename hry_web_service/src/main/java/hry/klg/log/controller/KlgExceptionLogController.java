 ...
 */
package hry.klg.log.controller;
 ...
 */
@Controller
@RequestMapping("/log/klgexceptionlog")
public class KlgExceptionLogController extends BaseController<KlgExceptionLog, Long> {
	...
	public ModelAndView see(@PathVariable Long id){
		...
		ModelAndView mav = new ModelAndView("/klg/log/klgexceptionlogsee");
	...
	public ModelAndView modifysee(@PathVariable Long id){
		KlgExceptionLog klgExceptionLog = service.get(id);
		ModelAndView mav = new ModelAndView("/klg/log/klgexceptionlogmodify");
		mav.addObject("model", klgExceptionLog);
		return mav;
	}
