...
public class DealRecord extends BaseModel {
	...
	@Transient
	private BigDecimal newShiftToMoney; // 新增转入金额

	@Transient
	private BigDecimal teamAsset; // 团队业绩
	...
	public BigDecimal getTeamAsset() {
		return teamAsset;
	}

	public void setTeamAsset(BigDecimal teamAsset) {
	...
	public BigDecimal getNewShiftToMoney() {
		return newShiftToMoney;
	}

	public void setNewShiftToMoney(BigDecimal newShiftToMoney) {
		this.newShiftToMoney = newShiftToMoney;
	}
