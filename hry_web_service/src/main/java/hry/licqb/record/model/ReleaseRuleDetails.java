...
public class ReleaseRuleDetails extends BaseModel {
	...
	@Column(name= "lastMonthTeamAward")
	private BigDecimal lastMonthTeamAward; // 上个月团队业绩

	public BigDecimal getLastMonthTeamAward() {
		return lastMonthTeamAward;
	}

	public void setLastMonthTeamAward(BigDecimal lastMonthTeamAward) {
		this.lastMonthTeamAward = lastMonthTeamAward;
	}
