 ...
 <div class="centerRowBg centerRowBg_admin" >
	 <div class="row">
		 <div class="col-md-12">
			 <h3 class="page-header">修改邮箱模板  <button type="button"  class="btn  btn-info-blue pull-right"  onclick="loadUrl('${ctx}/language.do?u=/admin/web/mailtemplatelist')" > <i class="fa fa-mail-forward"></i>返回</button></h3>
		 </div>
	 </div>
		 ...
		 <div class="row">
			<div class="col-md-4 column">
				...
				<div class="form-group">
					 ...
					 <input type="text" class="form-control" name="tempName" id="tempName" value="${model.tempName}"/>
				</div>
				<div class="form-group">
					 <label for="tempKey">模板类型</label>
					<@HrySelect key="mailTempKey"  name="tempKey"  id="tempKey"   value="${model.tempKey}"> </@HrySelect>
				</div>
				<div class="form-group">
				...
				<div class="form-group">
					 ...
					 <@HrySelect key="yesno"  name="tempStatus"  id="tempStatus"  value="${model.tempStatus}"  > </@HrySelect>
				</div>
