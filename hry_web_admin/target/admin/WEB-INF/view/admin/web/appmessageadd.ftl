...
<#include "/base/base.ftl">
  <div class="centerRowBg centerRowBg_admin">
      <div class="row">
          <div class="col-md-12">
              <h3 class="page-header">手动撰写站内信
                  <button type="button" class="btn btn-info-blue pull-right"
                          onclick="loadUrl('${ctx}/v.do?u=/admin/web/appmessagelist')"><i
              ...
              <div class="col-md-12">
                  <div class="form-group">
                      ...
                      <label for="title"></label>
                          ...
                          <button type="button" id="selectedUser" class="btn btn-primary">收件人(0人)</button>
                      </span>
                  </div>
              </div>
          </div>
              ...
              <div class="col-md-12">
                  ...
                  <div class="row">
                      ...
                      <div class="col-md-2 column">
                          <button type="button" id="addSubmit" class="btn btn-primary btn-block">保存到草稿箱</button>
                      </div>
                      <div class="col-md-2 column">
