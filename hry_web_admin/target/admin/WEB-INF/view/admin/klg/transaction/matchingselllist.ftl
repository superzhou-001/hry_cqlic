...
<#include "/base/base.ftl">
 ...
 <div class="row">
     <div class="col-lg-12">
         <h3 class="page-header">卖单维度匹配</h3>
     </div>
 </div>
	 ...
	 <div class="col-lg-12">
	 		<form id="table_query_form_sell" class="table_query_form_sell" style="padding:5px 0 0 10px;border: 1px solid #1ea2e3;">
		        <div class="row">
		            <div class="_params">
		                 ...
		                 <div class="col-md-2 column">
		                     <div class="form-group">
		                         <label for="mobilePhone">预约卖出天数</label>
		                         <input type="text" class="form-control" tablesearch name="sellDay"/>
		                     </div>
		                 </div>
		                 <div class="col-md-2 column">
		                    <div class="form-group">
		                        <label for="entrustTime_GT">预约排单时间起</label>
		                ...
		                <div class="col-md-2 column">
		                    <div class="form-group">
		                        <label for="entrustTime_GT">预约排单时间止</label>
		                 ...
		                 <div class="col-md-2 column">
		                    <div class="form-group">
		                        <label for="entrustTime_GT">预约卖出时间起</label>
		                        <input type="text" class="form-control" name="created_GTME" id="entrustTime_GTME" readonly tablesearch
		                               data-date-format="yyyy-mm-dd" data-min-view="month"
		                               value="${(info.birthday?string("yyyy-MM-dd"))!}">
		                    </div>
		                </div>
		                <div class="col-md-2 column">
		                    <div class="form-group">
		                        <label for="entrustTime_GT">预约卖出时间止</label>
		                        <input type="text" class="form-control" name="created_LTME" id="entrustTime_LTME" readonly tablesearch
		                               data-date-format="yyyy-mm-dd" data-min-view="month"
		                               value="${(info.birthday?string("yyyy-MM-dd"))!}">
		                    </div>
		                </div>
	        ...
	        <div class="title_sty">
	         ...
	         <div id="toolbar2">
                ...
                <button id="sellAlonePipeiSubmit" class="btn btn-info-blue">
                    <i class="glyphicon glyphicon-share"></i>卖单单独匹配
                </button>
 	    	 </div>
	        <p style="color:red;margin: 10px 0 0;"  id="smeSellSum">已选卖单：0 SME</p>
	 	    <table id="table_sell"
 ...
 seajs.use(["js/admin/klg/transaction/matchingsell","js/base/HrySelect","js/base/HryDate"],function(o,HrySelect,t){
    HrySelect.init();
    t.init();
 	o.listbuy();
 	o.listsell();
