...
<div class="centerRowBg centerRowBg_admin">
 <div class="row">
     <div class="col-lg-12">
         <h3 class="page-header">C2C待处理订单管理</h3>
     </div>
 </div>
 <div class="row">
 	<div class="col-md-12">
        ...
        <div id="toolbar">
            <button id="see" class="btn btn-info-blue" permissions="/admin/c2c/c2ctransaction/see" >
                <i class="glyphicon glyphicon-share"></i>查看订单
            </button>
            <button id="confirm" class="btn btn-info-blue" permissions="/admin/c2c/c2ctransaction/confirm" >
                <i class="glyphicon glyphicon-remove"></i>确认到账
            </button>
            <button id="close" class="btn btn-info-blue" permissions="/admin/c2c/c2ctransaction/close"  >
