 ...
 <div class="row">
 <div class="col-md-12">
     <h3 class="page-header">全部错误余额信息 <button type="button"  class="btn btn-info-blue pull-right"  onclick="loadUrl('${ctx}/v.do?u=admin/customer/checkaccount')" > <i class="fa fa-mail-forward"></i>返回</button></h3>
 </div>
 </div>
...
<script type="text/html" id="tmpl-all-record">
   ...
   <div class="row">
       <div class="col-md-6 column">
           <table class="table table-striped">
               ...
               <tbody   >
                <%for (var x = 0; x < list[i].oldAccountFundInfolist.length; x++) {%>
                <tr>
                    <td><%=list[i].oldAccountFundInfolist[x].userName%></td>
                    <td><%=list[i].oldAccountFundInfolist[x].coinCode%></td>
                    <td><%=list[i].oldAccountFundInfolist[x].hotMoney%></td>
                    <td><%=list[i].oldAccountFundInfolist[x].coldMoney%></td>
                </tr>
                <%}%>
               </tbody>
           </table>
       ...
       <div class="col-md-6 column">
           <table class="table table-striped">
               ...
               <tbody >
               <%for (var x = 0; x < list[i].newAccountFundInfolist.length; x++) {%>
               <tr>
                   <td><%=list[i].newAccountFundInfolist[x].coinCode%></td>
                   <td><%=list[i].newAccountFundInfolist[x].hotMoney%></td>
                   <td><%=list[i].newAccountFundInfolist[x].coldMoney%></td>
               </tr>
               <%}%>
               </tbody>
           </table>
   ...
   <div class="row">
       <div class="col-md-2 column">
           <button type="button" id="openinfo" customerid='<%=list[i].customerId%>' class="btn btn-info-blue" >资金详情</button>
       </div>
   </div>
