...
<div class="row">
    <div class="col-md-12">
        <h3 class="page-header">添加等级  <button type="button"  class="btn btn-info-blue pull-right"  onclick="loadUrl('${ctx}/v.do?u=/admin/licqb/platform/levelconfiglist')" > <i class="fa fa-mail-forward"></i>返回</button></h3>
    </div>
</div>
...
<div class="row">
	<div class="col-md-4 column">
		...
		<div class="form-group">
			 ...
			 <input type="text" class="form-control" name="levelAward" id="levelAward" />
		</div>
	</div>
</div>
