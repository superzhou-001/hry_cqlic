 ...
 <div class="row">
 <div class="col-md-12">
     <h3 class="page-header">ApplyTeamAward--Modify  <button type="button"  class="btn btn-info-blue pull-right"  onclick="loadUrl('${ctx}/v.do?u=/admin/licqb/platform/applyteamawardlist')" > <i class="fa fa-mail-forward"></i>返回</button></h3>
 </div>
 </div>
