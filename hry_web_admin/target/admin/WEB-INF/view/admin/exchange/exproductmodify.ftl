     ...
     <div class="row">
         ...
         <div class="col-md-4 column">
             ...
             <div class="form-group">
                 ...
                 <input type="text" class="form-control" name="coinCode" value="${model.coinCode}"id="coinCode" readonly/>
             </div>
         </div>
     </div>
     ...
     <div class="row">
         ...
         <div class="col-md-4 column">
             <div class="form-group">
                 ...
                 <input type="text" class="form-control" name="totalNum" value="${model.totalNum?string(",###")}" id="totalNum"/>
             </div>
         </div>
     ...
     <div class="row">
         <div class="col-md-4 column">
             ...
             <div class="form-group">
                 ...
                 <input type="text" class="form-control" name="stock" value="${model.stock?string(",###")}" id="stock" />
             </div>
         </div>
