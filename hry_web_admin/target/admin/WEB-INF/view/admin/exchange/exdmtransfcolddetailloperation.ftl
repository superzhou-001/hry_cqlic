...
<#include "/base/base.ftl">
 ...
 <div class="row">
     <div class="col-lg-12">
         <h3 class="page-header">归集币种冷账户</h3>
     </div>
 </div>
 <div class="row">
			<div class="_params">
 ...
 <div class="row">
 	<div class="col-md-12">
 	    ...
 	    <div id="toolbar">
             <button id="toCold" class="btn btn-info-blue">
     ...
     <div id="toColdAccount" style="display:none; top:20px;">
         <form style="text-align: center;">
             ...
             <input type="input" id="toMoney" placeholder="金额" style="text-align: center;margin-top: 20px;"/>
