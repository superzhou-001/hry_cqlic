 ...
 <div class="row">
 <div class="col-md-12">
     <h3 class="page-header">IcoExperience--Modify  <button type="button"  class="btn btn-info-blue pull-right"  onclick="loadUrl('${ctx}/v.do?u=/admin/ico/experience/icoexperiencelist')" > <i class="fa fa-mail-forward"></i>返回</button></h3>
 </div>
 </div>
 ...
 <div class="row">
	<div class="col-md-4 column">
		...
		<div class="form-group">
			 ...
			 <input type="text" class="form-control" name="account_type" id="account_type" value="${model.account_type}"/>
		</div>
		<div class="form-group">
			 <label for="coinNum">持币数量</label>
			 <input type="text" class="form-control" name="coinNum" id="coinNum" value="${model.coinNum}"/>
		</div>
		<div class="form-group">
		...
		<div class="form-group">
			 ...
			 <input type="text" class="form-control" name="experienceNum" id="experienceNum" value="${model.experienceNum}"/>
		</div>
		<div class="form-group">
