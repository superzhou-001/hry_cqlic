 ...
 <div class="row">
 <div class="col-md-12">
     <h3 class="page-header">IcoAwardRecord--See  <button type="button"  class="btn btn-info-blue pull-right"  onclick="loadUrl('${ctx}/v.do?u=/admin/ico/award/icoawardrecordlist')" > <i class="fa fa-mail-forward"></i>返回</button></h3>
 </div>
 </div>
 ...
 <div class="row">
 	<div class="col-md-4 column">
		...
		<div class="form-group">
			 ...
			 <input type="text" class="form-control" name="account_id" id="account_id" value="${model.account_id}" disabled/>
		</div>
		<div class="form-group">
			 <label for="award_type">推荐类型（1 首持奖励， 2  推荐奖励）</label>
			 <input type="text" class="form-control" name="award_type" id="award_type" value="${model.award_type}" disabled/>
		</div>
		<div class="form-group">
		...
		<div class="form-group">
			 ...
			 <input type="text" class="form-control" name="referrals_id" id="referrals_id" value="${model.referrals_id}" disabled/>
		</div>
		<div class="form-group">
			 <label for="referrals_email">被推荐人邮箱</label>
			 <input type="text" class="form-control" name="referrals_email" id="referrals_email" value="${model.referrals_email}" disabled/>
		</div>
		<div class="form-group">
			 <label for="referrals_mobile">被推荐人手机号</label>
			 <input type="text" class="form-control" name="referrals_mobile" id="referrals_mobile" value="${model.referrals_mobile}" disabled/>
		</div>
		<div class="form-group">
			 <label for="award_radix">奖励基数</label>
			 <input type="text" class="form-control" name="award_radix" id="award_radix" value="${model.award_radix}" disabled/>
		</div>
		<div class="form-group">
			 <label for="award_quantity">奖励数量</label>
			 <input type="text" class="form-control" name="award_quantity" id="award_quantity" value="${model.award_quantity}" disabled/>
		</div>
		<div class="form-group">
			 <label for="award_num">奖励流水号</label>
			 <input type="text" class="form-control" name="award_num" id="award_num" value="${model.award_num}" disabled/>
		</div>
		<div class="form-group">
