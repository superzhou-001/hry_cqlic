...
<#include "/base/base.ftl">
 ...
 <div class="row">
     <div class="col-lg-12">
         <h3 class="page-header">币币交易记录</h3>
     </div>
 </div>
        ...
        <div class="row">
            <div class="_params">
                <form id="table_query_form">
                    ...
                    <div class="col-md-2 column">
                        <div class="form-group">
                            <label for="payCoinCode">交易币种</label>
                            <input type="text" class="form-control" tablesearch name="payCoinCode"/>
                        </div>
                    </div>
 ...
 seajs.use(["js/admin/ico/account/IcoBuyOrder","js/base/HrySelect","js/base/HryDate"],function(o,HrySelect,HryDate){
     o.list();
     HrySelect.init();
     HryDate.init();
