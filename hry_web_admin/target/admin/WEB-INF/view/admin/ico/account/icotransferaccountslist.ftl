...
<#include "/base/base.ftl">
        ...
        <div class="row">
            <div class="_params">
				<form id="table_query_form">
					...
					<div class="col-md-2 column">
						<div class="form-group">
							<label for="toEmail">转入邮箱</label>
							<input type="text" class="form-control" tablesearch name="toEmail"/>
						</div>
					</div>
					<div class="col-md-2 column">
						<div class="form-group">
							<label for="toMobilePhone">转入手机号</label>
							<input type="text" class="form-control" tablesearch name="toMobilePhone"/>
						</div>
					</div>
					<div class="col-md-2 column">
						<div class="form-group">
 ...
 seajs.use(["js/admin/ico/account/IcoTransferAccounts","js/base/HrySelect","js/base/HryDate"],function(o,HrySelect,HryDate){
	 o.list();
	 HrySelect.init();
	 HryDate.init();
