...
<#include "/base/base.ftl">
 ...
 <div class="row">
     <div class="col-lg-12">
		 <#if status==1>
			 <h3 class="page-header">产出已发放</h3>
			 <#else>
			 	 <h3 class="page-header">产出待发放</h3>
		</#if>
     </div>
 </div>
 ...
 seajs.use(["js/admin/mining/ExMining","js/base/HrySelect","js/base/HryDate"],function(o,HrySelect,HryDate){
     HryDate.init();
     HrySelect.init();
 	o.list();
 });
