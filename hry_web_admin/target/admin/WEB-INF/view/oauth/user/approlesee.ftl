...
<div class="row">
    <div class="col-md-12">
        <h3 class="page-header">查看角色 <button type="button"  class="btn btn-info-blue pull-right"  onclick="loadUrl(_ctx+'/v.do?u=/oauth/user/approlelist')" > <i class="fa fa-mail-forward"></i>返回</button></h3>
    </div>
</div>
...
<div class="row">
	<div class="col-md-4 column">
		...
		<div class="form-group">
			 ...
			 <input type="text" class="form-control" name="remark" id="remark" value="${model.remark}" readonly/>
		</div>
	</div>
</div>
