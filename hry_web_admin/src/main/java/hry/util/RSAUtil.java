...
public class RSAUtil {
    ...
    public static Map<String, Object> getKeys() throws NoSuchAlgorithmException{
        ...
        logger.info("系数Modulus："+publicKey.getModulus()+",加密指数PublicExponent："+publicKey.getPublicExponent());
        //甲方私钥
        RSAPrivateKey privateKey=(RSAPrivateKey) keyPair.getPrivate();
        logger.info("系数Modulus："+privateKey.getModulus()+",解密指数PrivateExponent："+privateKey.getPrivateExponent());
        //将密钥存储在map中
    ...
    public static String getPublicKey(Map<String, Object> keyMap){
        ...
        logger.info("公钥为publicKey：" + publicKey);
        return publicKey;
    }
    /**
    ...
    public static String encryptByPublicKey(String data,String publicKey) throws Exception{
        logger.info("公钥加密前数据：" + data + ",公钥为：" + publicKey);
        ...
        logger.info("公钥加密后数据为：" + encodeData);
        return encodeData;
    }
    /**
    ...
    public static String decryptByPrivateKey(String data,String privateKey) throws Exception{
        logger.info("私钥解密前数据：" + data + ",私钥为：privateKey：" + privateKey);
    ...
    public static String encryptByPrivateKey(String data ,String privateKey) throws Exception{
        //logger.info("私钥加密前数据：" + data + ",私钥为privateKey：" + privateKey);
        byte[] key = Base64.decodeBase64(privateKey);
        byte[] datab = data.getBytes("utf-8");
        //取得私钥
        PKCS8EncodedKeySpec pkcs8KeySpec=new PKCS8EncodedKeySpec(key);
    ...
    public static String decryptByPublicKey(String data,String publicKey) throws Exception{
        //logger.info("公钥解密前数据：" + data + ",公钥为：publicKey：" + publicKey);
        byte[] key = Base64.decodeBase64(publicKey);
        byte[] dataB = Base64.decodeBase64(data);
        //实例化密钥工厂
        KeyFactory keyFactory=KeyFactory.getInstance(KEY_ALGORITHM);
        ...
        //logger.info("公钥解密后数据：" + decrypData);
        return decrypData;
    }
    /**
     *
