 ...
 <div class="row">
 <div class="col-md-12">
     <h3 class="page-header">CustomerLevel--See  <button type="button"  class="btn btn-info-blue pull-right"  onclick="loadUrl('${ctx}/v.do?u=/admin/licqb/platform/customerlevellist')" > <i class="fa fa-mail-forward"></i>返回</button></h3>
 </div>
 </div>
 ...
 <div class="row">
 	<div class="col-md-4 column">
		...
		<div class="form-group">
			 ...
			 <input type="text" class="form-control" name="levelId" id="levelId" value="${model.levelId}" disabled/>
		</div>
		<div class="form-group">
		...
		<div class="form-group">
			 ...
			 <input type="text" class="form-control" name="isTeamAward" id="isTeamAward" value="${model.isTeamAward}" disabled/>
		</div>
	</div>
 </div>
