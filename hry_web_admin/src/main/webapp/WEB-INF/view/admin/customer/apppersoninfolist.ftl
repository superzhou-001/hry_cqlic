...
<#include "/base/base.ftl">
 <div class="row">
     <div class="col-lg-12">
         <h3 class="page-header">AppPersonInfo--Tables</h3>
     </div>
 </div>
 <div class="row">
			<div class="_params">
 ...
 <div class="row">
 	<div class="col-md-12">
 	    ...
 	    <div id="toolbar">
             <button id="add" class="btn  btn-info-blue" onclick="loadUrl('${ctx}/v.do?u=/admin/customer/apppersoninfoadd')" >
