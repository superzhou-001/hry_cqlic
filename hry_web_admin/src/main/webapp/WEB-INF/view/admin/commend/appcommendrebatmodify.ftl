 ...
 <div class="row">
 <div class="col-md-12">
     <h3 class="page-header">AppCommendRebat--Modify  <button type="button"  class="btn btn-info-blue pull-right"  onclick="loadUrl('${ctx}/v.do?u=/admin/commend/appcommendrebatlist')" > <i class="fa fa-mail-forward"></i>返回</button></h3>
 </div>
 </div>
 ...
 <div class="row">
	<div class="col-md-4 column">
		...
		<div class="form-group">
			 ...
			 <input type="text" class="form-control" name="rebatMoney" id="rebatMoney" value="${model.rebatMoney}"/>
		</div>
		<div class="form-group">
