 <!-- Copyright:    -->
 <!-- KlgAmountLimitationRecordList.html     -->
 <!-- @author:      lzy  -->
 <!-- @version:     V1.0             -->
...
<#include "/base/base.ftl">
 ...
 <div class="row">
     <div class="col-lg-12">
         <h3 class="page-header">购买限制记录</h3>
     </div>
 </div>
 	...
 	<div class="col-md-12">
        ...
        <div class="row">
            <div class="_params">
				...
				<div class="col-md-2 column">
					<div class="form-group">
						<label for="level">限制类型</label>
						<@HrySelect key="limit_type" name="type" id="type"></@HrySelect>
					</div>
				</div>
				<div class="col-md-2 column">
					<div class="form-group">
 ...
 <script type="text/javascript">
	 seajs.use(["js/admin/klg/limit/KlgAmountLimitationRecord","js/base/HrySelect","js/base/HryDate"],function(o,HrySelect,HryDate){
		 o.list();
		 HrySelect.init();
		 HryDate.init();
