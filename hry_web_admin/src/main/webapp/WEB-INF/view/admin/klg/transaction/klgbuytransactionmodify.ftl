 ...
 <div class="row">
 <div class="col-md-12">
     <h3 class="page-header">KlgBuyTransaction--Modify  <button type="button"  class="btn btn-info-blue pull-right"  onclick="loadUrl('${ctx}/v.do?u=/admin/klg/transaction/klgbuytransactionlist')" > <i class="fa fa-mail-forward"></i>返回</button></h3>
 </div>
 </div>
 ...
 <div class="row">
	<div class="col-md-4 column">
		...
		<div class="form-group">
			 ...
			 <input type="text" class="form-control" name="firstMoney" id="firstMoney" value="${model.firstMoney}"/>
		</div>
		<div class="form-group">
			 <label for="lastMoney">尾款</label>
			 <input type="text" class="form-control" name="lastMoney" id="lastMoney" value="${model.lastMoney}"/>
		</div>
		<div class="form-group">
			 <label for="interestMoney">利息</label>
			 <input type="text" class="form-control" name="interestMoney" id="interestMoney" value="${model.interestMoney}"/>
		</div>
		<div class="form-group">
			 <label for="trusteeshipStatus">托管状态：1否 2是</label>
			 <input type="text" class="form-control" name="trusteeshipStatus" id="trusteeshipStatus" value="${model.trusteeshipStatus}"/>
		</div>
		<div class="form-group">
			 <label for="rushOrders">是否抢单：1否 2是</label>
			 <input type="text" class="form-control" name="rushOrders" id="rushOrders" value="${model.rushOrders}"/>
		</div>
		<div class="form-group">
