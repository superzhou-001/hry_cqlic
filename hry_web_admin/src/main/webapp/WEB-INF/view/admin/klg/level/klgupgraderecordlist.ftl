...
<#include "/base/base.ftl">
				...
				<form id="table_query_form">
					...
					<div class="col-md-2 column">
						<div class="form-group">
							...
							<@HrySelect url="${ctx}/klg/level/klglevelconfig/findAll"  itemvalue="id"  itemname="levelName"  name="newLevel"  id="newLevel"   > </@HrySelect>
						</div>
					</div>
					<div class="col-md-2 column">
						<div class="form-group">
							<label for="oldLevel">原级别</label>
							<@HrySelect url="${ctx}/klg/level/klglevelconfig/findAll"  itemvalue="id"  itemname="levelName"  name="oldLevel"  id="oldLevel"   > </@HrySelect>
						</div>
					</div>
 ...
 seajs.use(["js/admin/klg/level/KlgUpgradeRecord","js/base/HrySelect","js/base/HryDate"],function(o,HrySelect,HryDate){
	 HrySelect.init();
	 HryDate.init();
	 o.list();
 });
