...
<#include "/base/base.ftl">
 ...
 <div class="row">
     <div class="col-lg-12">
         <h3 class="page-header">推荐奖励明细</h3>
     </div>
 </div>
            ...
            <div class="_params">
                ...
                <div class="col-md-2 column">
                    <div class="form-group">
                        ...
                        <select id="rewardType" class="form-control"  name="rewardType">
                            <option value="">请选择</option>
                            <option value="1">见点奖</option>
                            <option value="2">级差奖</option>
                        </select>
                    </div>
                </div>
                 <div class="col-md-2 column">
 ...
 seajs.use(["js/admin/klg/reward/KlgReward","js/base/HrySelect","js/base/HryDateTop"],function(o,HrySelect,t){
    HrySelect.init();
 	o.list();
 	t.init();
 });
