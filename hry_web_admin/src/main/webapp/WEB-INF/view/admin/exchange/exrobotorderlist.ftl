...
<div class="centerRowBg centerRowBg_admin">
    <div class="row">
        <div class="col-lg-12">
            <h3 class="page-header">机器人成交查询</h3>
        </div>
    </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-2 column">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="entrustTime_GT" id="entrustTime_GT" readonly tablesearch  data-date-format="yyyy-mm-dd" data-min-view="month" value="${(info.birthday?string("yyyy-MM-dd"))!}">
                        </div>
                    </div>
                    <div class="col-md-2 column">
                        <div class="form-group">
                            <label for="entrustTime_GT">结束时间</label>
                            <input type="text" class="form-control" name="entrustTime_LT" id="entrustTime_LT" readonly tablesearch  data-date-format="yyyy-mm-dd" data-min-view="month" value="${(info.birthday?string("yyyy-MM-dd"))!}">
                        </div>
                    </div>
 ...
 <script type="text/javascript">
     seajs.use(["js/admin/exchange/ExRobotOrder","js/base/HrySelect","js/base/HryDate"],function(o,HrySelect,HryDate){
         HryDate.init();
         HrySelect.init();
         o.list();
     });
