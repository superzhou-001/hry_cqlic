 ...
 <div class="row">
 <div class="col-md-12">
     <h3 class="page-header">AppAccountRecord--Modify  <button type="button"  class="btn btn-info-blue pull-right"  onclick="loadUrl('${ctx}/v.do?u=/admin/exchange/appaccountrecordlist')" > <i class="fa fa-mail-forward"></i>返回</button></h3>
 </div>
 </div>
 ...
 <div class="row">
	<div class="col-md-4 column">
		<div class="form-group">
			 ...
			 <input type="text" class="form-control" name="appAccountId" id="appAccountId" value="${model.appAccountId}"/>
		</div>
		<div class="form-group">
			 <label for="appAccountNum">appAccountNum</label>
			 <input type="text" class="form-control" name="appAccountNum" id="appAccountNum" value="${model.appAccountNum}"/>
		</div>
		<div class="form-group">
		...
		<div class="form-group">
			 ...
			 <input type="text" class="form-control" name="currencyName" id="currencyName" value="${model.currencyName}"/>
		</div>
		<div class="form-group">
		...
		<div class="form-group">
			 ...
			 <input type="text" class="form-control" name="customerAccount" id="customerAccount" value="${model.customerAccount}"/>
		</div>
		<div class="form-group">
