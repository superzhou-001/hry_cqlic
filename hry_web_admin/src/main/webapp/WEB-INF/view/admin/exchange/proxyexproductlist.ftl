 ...
 <div class="row">
 	<div class="col-md-12">
        ...
        <div class="row">
 	    ...
 	    <div id="toolbar">
             <button id="add" class="btn  btn-info-blue" onclick="loadUrl('${ctx}/v.do?u=/admin/exchange/proxyexproductadd')" permissions="/admin/exchange/exproduct/add" >
...
<#--
            ...
            <button id="publish" class="btn  btn-info-blue"  permissions="/admin/exchange/exproduct/publish">
                <i class="glyphicon glyphicon-remove"></i>发行
            </button>-->
         <#--   <button id="delistProduct" class="btn  btn-info-blue" >
                <i class="glyphicon glyphicon-remove"></i>退市
            </button>-->
 	    </div>
 	    <table id="table"
