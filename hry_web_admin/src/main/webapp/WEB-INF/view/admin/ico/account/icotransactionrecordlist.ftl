...
<#include "/base/base.ftl">
        ...
        <div class="row">
            <div class="_params">
                <form id="table_query_form">
                    ...
                    <div class="col-md-2 column">
                        <div class="form-group">
                            <label for="state">收支类型</label>
                          <@HrySelect key="fundStatus"  name="state"  id="state" tablesearch="true"> </@HrySelect>
                        </div>
                    </div>
                    <div class="col-md-2 column">
                        <div class="form-group">
                            <label for="type">交易方式</label>
                       <@HrySelect key="transaction_type"  name="type"  id="type" tablesearch="true"> </@HrySelect>
                        </div>
                    </div>
 ...
 <script type="text/javascript">
     seajs.use(["js/admin/ico/account/IcoTransactionRecord","js/base/HrySelect","js/base/HryDate"],function(o,HrySelect,HryDate){
         o.list();
         HrySelect.init();
         HryDate.init();
