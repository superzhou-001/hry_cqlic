 ...
 <div class="row">
 <div class="col-md-12">
     <h3 class="page-header">IcoLockError--Modify  <button type="button"  class="btn btn-info-blue pull-right"  onclick="loadUrl('${ctx}/v.do?u=/admin/ico/account/icolockerrorlist')" > <i class="fa fa-mail-forward"></i>返回</button></h3>
 </div>
 </div>
 ...
 <div class="row">
	<div class="col-md-4 column">
		...
		<div class="form-group">
			 ...
			 <input type="text" class="form-control" name="mqMessage" id="mqMessage" value="${model.mqMessage}"/>
		</div>
		<div class="form-group">
			 <label for="errorInfo">错误信息</label>
			 <input type="text" class="form-control" name="errorInfo" id="errorInfo" value="${model.errorInfo}"/>
		</div>
		</div>
 </div>
