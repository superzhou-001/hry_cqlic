 <!-- Copyright:    -->
 <!-- IcoDividendManualRecordList.html     -->
 <!-- @author:      lzy  -->
 <!-- @version:     V1.0             -->
...
<#include "/base/base.ftl">
 ...
 <div class="row">
     <div class="col-lg-12">
         <h3 class="page-header">后台分红管理</h3>
     </div>
 </div>
 ...
 <div id="add-main" style="display: none;">
		 <div class="row">
			 <div class="col-md-4 column">
				 <div class="form-group">
					 <label for="dividendNum">分红总量</label>
					 <input type="text" class="form-control" name="dividendNum" id="dividendNum" />
				 </div>
				 <div class="form-group">
					 <label for="coinCode">币种名称</label>
					 <@HrySelect url="${ctx}/exchange/exproduct/findall"  itemvalue="coinCode"  itemname="coinCode"  name="add_coinCode"  id="add_coinCode"   > </@HrySelect>
				 </div>
				 <div class="form-group">
					 <label for="reason">分红原因</label>
					 <input type="text" class="form-control" name="reason" id="reason" />
				 </div>
				 <div class="form-group">
					 <label for="reason">大于会员等级</label>
					 <@HrySelect key="member_Lev"  name="levelSort"  id="levelSort" tablesearch="true"> </@HrySelect>
				 </div>
				 <div class="layui-input-block">
					 <button class="layui-btn" lay-submit lay-filter="save" id="grantDividend">立即提交</button>
 ...
 seajs.use(["js/admin/ico/dividend/IcoDividendManualRecord","js/base/HrySelect","js/base/HryDate"],function(o,HrySelect,HryDate){
	 o.list();
	 HryDate.init();
	 HrySelect.init();
 });
