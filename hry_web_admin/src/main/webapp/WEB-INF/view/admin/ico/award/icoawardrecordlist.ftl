...
<#include "/base/base.ftl">
 ...
 <div class="row">
     <div class="col-lg-12">
         <h3 class="page-header">推荐奖励查询</h3>
     </div>
 </div>
 ...
 <div class="row">
 	<div class="col-md-12">
        <div class="_params">
            <form id="table_query_form">
                ...
                <div class="col-md-2 column">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" tablesearch name="referrals_email"/>
                    </div>
                </div>
                <div class="col-md-2 column">
                    <div class="form-group">
                        <label for="referrals_mobile">被推荐人手机号</label>
                        <input type="text" class="form-control" tablesearch name="referrals_mobile"/>
                    </div>
                </div>
                <div class="col-md-2 column">
                    <div class="form-group">
 	    ...
 	    <div id="toolbar">
            <!--
             <button id="add" class="btn btn-info-blue" onclick="loadUrl('${ctx}/v.do?u=/admin/ico/award/icoawardrecordadd')" >
 ...
 seajs.use(["js/admin/ico/award/IcoAwardRecord","js/base/HrySelect","js/base/HryDate"],function(o,HrySelect,HryDate){
     o.list();
     HrySelect.init();
     HryDate.init();
