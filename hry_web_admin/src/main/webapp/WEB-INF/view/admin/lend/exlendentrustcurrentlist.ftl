...
<#include "/base/base.ftl">
 ...
 seajs.use(["js/admin/lend/ExLendEntrust", "js/base/HrySelect", "js/base/HryDate"],function(o, HrySelect, HryDate){
     HryDate.init();
     HrySelect.init();
 	o.list("listnow");
 });
