...
<#include "/base/base.ftl">
 <div class="row">
     <div class="col-lg-12">
         <h3 class="page-header">AppUser--Tables</h3>
     </div>
 </div>
 ...
 <div class="row">
 	<div class="col-md-12">
 	    <div id="toolbar">
             <button id="add" class="btn  btn-info-blue" onclick="loadUrl('/oauth/user/appuseradd')" >
 ...
 seajs.use("js/admin/user/AppOrganization",function(o){
 	o.list();
 });
