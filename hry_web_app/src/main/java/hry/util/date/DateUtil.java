...
public class DateUtil {
	...
	public static String addDay(String date, int n,String dateFormat) {
		try {
			DateFormat df = new SimpleDateFormat(dateFormat);
			Date dd = df.parse(date);
			Calendar calendar = Calendar.getInstance();
			calendar.setTime(dd);
			calendar.add(Calendar.DATE, n);//加一天
	...
	public static String addMonth(String date, int n,String dateFormat) {
		try {
			DateFormat df = new SimpleDateFormat(dateFormat);
			Date dd = df.parse(date);
			Calendar calendar = Calendar.getInstance();
